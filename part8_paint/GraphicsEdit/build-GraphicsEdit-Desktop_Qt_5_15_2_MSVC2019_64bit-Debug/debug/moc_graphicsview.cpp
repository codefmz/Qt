...
#include <memory>
#include "../../GraphicsEdit/graphicsview.h"
...
QT_MOC_LITERAL(5, 40, 18), // "mouseDoubleClicked"
QT_MOC_LITERAL(6, 59, 5), // "point"
QT_MOC_LITERAL(7, 65, 12) // "mouseClicked"

    },
    "GraphicsView\0keyPress\0\0QKeyEvent*\0"
    "event\0mouseDoubleClicked\0point\0"
    "mouseClicked"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mouseDoubleClicked((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: _t->mouseClicked((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GraphicsView::*)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::keyPress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::mouseDoubleClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GraphicsView::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::mouseClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::keyPress(QKeyEvent * _t1)
{
...
// SIGNAL 1
void GraphicsView::mouseDoubleClicked(QPoint _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void GraphicsView::mouseClicked(QPoint _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };

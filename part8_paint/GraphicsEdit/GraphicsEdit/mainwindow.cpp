...
void MainWindow::on_mousePress(QPoint point)
{
    ...
    if(item != NULL)
    {
        itemInfo->setText(item->data(ItemId).toString() +" , " +
...
void MainWindow::on_actItem_Ellipse_triggered()
{
    ...
    ellipseItem->setFlags(QGraphicsItem::ItemIsFocusable
                       | QGraphicsItem::ItemIsSelectable
                       | QGraphicsItem::ItemIsMovable);
...
void MainWindow::on_actItem_Circle_triggered()
{
    ...
    circleItem->setFlags(QGraphicsItem::ItemIsFocusable
                       | QGraphicsItem::ItemIsSelectable
                       | QGraphicsItem::ItemIsMovable);
...
void MainWindow::on_actItem_Line_triggered()
{
    ...
    lineItem->setFlags(QGraphicsItem::ItemIsFocusable
                       | QGraphicsItem::ItemIsSelectable
                       | QGraphicsItem::ItemIsMovable);
    QPen pen(Qt::black);
    pen.setWidth(3);
...
void MainWindow::on_actItem_Polygon_triggered()
{
    ...
    polygonItem->setFlags(QGraphicsItem::ItemIsFocusable
                       | QGraphicsItem::ItemIsSelectable
                       | QGraphicsItem::ItemIsMovable);

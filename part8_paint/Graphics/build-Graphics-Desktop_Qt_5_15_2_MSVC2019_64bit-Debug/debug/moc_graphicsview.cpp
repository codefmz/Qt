...
QT_MOC_LITERAL(4, 35, 12) // "mouseClicked"

    },
    "GraphicsView\0mouseMovePoint\0\0point\0"
    "mouseClicked"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::mouseMovePoint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::mouseMovePoint(QPoint _t1)
{

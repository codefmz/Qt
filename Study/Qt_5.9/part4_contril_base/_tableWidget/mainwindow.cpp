    ...
    , ui(new Ui::MainWindow)
{
    ...
    QString qssTV = "QTableWidget::item:hover{background-color:rgb(92,188,227,200)}"
                    ...
                    "QHeaderView::section,QTableCornerButton:section{padding:3px; margin:0px; color:#DCDCDC;border:1px solid "
                    "#242424;border-left-width:0px;border-right-width:1px;border-top-width:0px;border-bottom-width:1px;background:qlineargradient(spread:pad,"
                    "x1:0,y1:0,x2:0,y2:1,stop:0 #646464,stop:1 #525252);}"
                    "QTableWidget{background-color:white;border:none;}";
    ui->tableInfo->setStyleSheet(qssTV);
